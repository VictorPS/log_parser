RSpec.describe LogParser::PageVisitList do
  ...
  subject { LogParser::PageVisitList.new([page_visit1, page_visit2, page_visit3, page_visit4]) }
  ...
  context '#decorate' do
    it 'returns a LogParser::PageVisitListDecorator object' do
      expect(subject.decorate).to be_a(LogParser::PageVisitListDecorator)
    end
  end

  context '.from_file' do
    subject { LogParser::PageVisitList.from_file('spec/fixtures/test_log.txt') }
